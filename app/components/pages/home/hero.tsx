...
export default function Hero({}: Props) {
  return (
    <Container className='relative bg-[url("/images/home/hero-mobile.webp")] sm:bg-[url("/images/home/hero.webp")] bg-cover bg-center lg:aspect-16/11 nav-white-section max-lg:pt-96'>
      ...
      <div className='z-10 h-full flex flex-col justify-end'>
        ...
        {/* Search */}
        <div className='my-8 bg-white flex flex-row max-w-lg h-12 items-center pr-1.5 rounded-full'>
          <Input
        ...
        {/* Filtering */}
        <div className='flex flex-row justify-between max-w-lg w-full mb-8 lg:mb-16 2xl:mb-24'>
          <div>
      ...
      {/* Gradient overlay */}
      <div className='absolute inset-0 pointer-events-none bg-linear-to-b from-transparent via-transparent via-25% lg:via-40% to-black/70'></div>
    </Container>
  );
}
